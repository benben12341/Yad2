...
class AddOrEditProductFragment : Fragment() {
    ...
    private fun getStateDropdown(view: View) {
        val dropdown: AutoCompleteTextView = view.findViewById<AutoCompleteTextView>(R.id.condition)
    ...
    private fun getGenderDropdown(view: View) {
        val dropdown: AutoCompleteTextView = view.findViewById<AutoCompleteTextView>(R.id.gender)
    ...
    private fun getProductCategory(view: View) {
        val dropdown: AutoCompleteTextView = view.findViewById<AutoCompleteTextView>(R.id.category)
        ...
        if (imageBitmap == null) {
            ...
            Model.instance.saveProductImage(
                ...
                Model.instance.saveProduct(product) {
                    progressBar!!.visibility = View.GONE
                    Toast.makeText(context, "saved product successfully!", Toast.LENGTH_LONG)
                        .show()
                    findNavController(title!!).navigateUp()
                }
            })
    ...
    private fun getProduct(id: String?): Product {
        ...
        return Product(
            ...
            if (isInArray(categories, this.category?.getText().toString())) this.category.getText()
